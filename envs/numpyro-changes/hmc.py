    ...
    **Example**
    ...
    def init_kernel(
        ...
        *,
        ...
        assert h_info['h_final'] <= h_info['h_init'], "Final h value must be less than initial." ### TODO
    ...
    def sample_kernel(hmc_state, model_args=(), model_kwargs=None):
        ...
        model_kwargs["h"] = hmc_state.adapt_state.h_state[0] ### TODO ADDED TO PASS TO LOGP
